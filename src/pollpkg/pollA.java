 ...
 * @author S A N D H U
 */
public class pollA extends javax.swing.JFrame {

    /**
     * Creates new form pollA
     */
    public pollA() {
        initComponents();
        setting_background();
   ...
   void setting_background()
    {
       Icon image = new ImageIcon( getClass().getResource( "A.JPG" ) );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pollA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
